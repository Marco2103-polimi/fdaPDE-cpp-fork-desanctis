...
// gcv 
TEST(case_study_mstrpde_gcv_north, NO2) {
    ...
    const std::string CV_type = "GCV";     // "GCV"  "5-folds" "15-folds"
    ...
    if(cov_strategy == "11"){ 
        covariate_type_for_data = "_sqrt.dens_log1p.elev.original"; 
    }
    ...
    const std::string mesh_type = "canotto_inla_NO2";    // fine come la run !! 
    ...
    // Marco 
    std::string path = "/mnt/c/Users/marco/OneDrive - Politecnico di Milano/Corsi/PhD/Codice/case_studies/mixed_NO2_north"; 
    ...
    MeshLoader<Triangulation<2, 2>> domain("mesh_north_" + mesh_type);   
...
// run 
TEST(case_study_mstrpde_run_north, NO2) {
    ...
    const std::string mesh_type = "canotto_inla_NO2";  // la run sulla mesh fine!
